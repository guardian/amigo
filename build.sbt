...
val awsV1SdkVersion = "1.12.646"
val awsV2SdkVersion = "2.23.7"
...
libraryDependencies ++= Seq(
  ...
  "com.gu.play-secret-rotation" %% "play-v30" % "7.0.0",
  "com.gu.play-secret-rotation" %% "aws-parameterstore-sdk-v2" % "7.0.0",
