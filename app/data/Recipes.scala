...
class Recipes(table: Table[Recipe.DbModel], baseImages: BaseImages) {
  ...
  def create(id: RecipeId,
    ...
    createdBy: String): ScanamoOps[Recipe] = {
  ...
  def update(recipe: Recipe, description: String, baseImage: BaseImage, roles: List[CustomisedRole], modifiedBy: String): ScanamoOps[Unit] = {
